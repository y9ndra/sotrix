          ...
          >
            <div className="settings-modal-card" role="dialog" aria-modal="true">
              ...
              <div className="settings-modal-body">
                ...
                {/* Community & GitHub Star Section */}
                <div className="settings-group">
                  <h4 className="settings-group-title">community</h4>
                  <a
                    href="https://github.com/y9ndra/sotrix"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="settings-star-card"
                    title="Star Sotrix on GitHub"
                  >
                    <div className="settings-star-left">
                      <div className="settings-star-icon-wrap">
                        <svg
                          viewBox="0 0 24 24"
                          width="17"
                          height="17"
                      ...
                      <div className="settings-star-info">
                        <span className="settings-star-title">Star on GitHub</span>
                        <span className="settings-star-desc">enjoying sotrix? support development with a star</span>
                      </div>
                    </div>
                    <div className="settings-star-badge">
                      <svg
                        viewBox="0 0 24 24"
                        width="13"
                        height="13"
                      ...
                      <svg
                        ...
                        style={{ width: "10px", height: "10px", stroke: "currentColor" }}
                        fill="none"
                        viewBox="0 0 24 24"
                        strokeWidth="2.5"
                      >
